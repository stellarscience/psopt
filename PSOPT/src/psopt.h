...
public:
   ...
   Prob*     problem = nullptr;
   Alg*      algorithm = nullptr;
   DMatrix*  P = nullptr;
   DMatrix*  sindex = nullptr;
   DMatrix*  w = nullptr;
   DMatrix*  D = nullptr;
   DMatrix*  D2 = nullptr;
   DMatrix*  snodes = nullptr;
   DMatrix*  old_snodes = nullptr;
   DMatrix*  xlb = nullptr;
   DMatrix*  xub = nullptr;
   DMatrix*  x0 = nullptr;
   DMatrix*  lambda = nullptr;
   DMatrix*  dual_costates = nullptr;
   DMatrix*  dual_path = nullptr;
   DMatrix*  dual_events = nullptr;
   DMatrix*  Xsnopt = nullptr;
   DMatrix*  gsnopt = nullptr;
   DMatrix*  DerivResid = nullptr;
   DMatrix*  h = nullptr;
   DMatrix*  Xdotgg = nullptr;
   DMatrix*  e = nullptr;
   DMatrix*  hgg = nullptr;
   DMatrix*  Xip = nullptr;
   DMatrix*  JacRow = nullptr;
   DMatrix*  Gip = nullptr;
   DMatrix*  GFip = nullptr;
   SparseMatrix*  Ax = nullptr;
   SparseMatrix*  As = nullptr;
   SparseMatrix*  Gsp = nullptr;
   DMatrix*  control_scaling = nullptr;
   DMatrix*  control_shift = nullptr;
   DMatrix*  state_scaling = nullptr;
   DMatrix*  parameter_scaling = nullptr;
   DMatrix*  state_shift = nullptr;
   DMatrix*  deriv_scaling = nullptr;
   DMatrix*  path_scaling = nullptr;
   DMatrix*  event_scaling = nullptr;
   DMatrix*  constraint_scaling = nullptr;
   DMatrix*  linkage = nullptr;
   DMatrix*  prev_states = nullptr;
   DMatrix*  prev_costates = nullptr;
   DMatrix*  prev_controls = nullptr;
   DMatrix*  prev_param = nullptr;
   DMatrix*  prev_path = nullptr;
   DMatrix*  prev_nodes = nullptr;
   DMatrix*  prev_t0 = nullptr;
   DMatrix*  prev_tf = nullptr;
   DMatrix*  Xdot = nullptr;
   DMatrix*  JacCol1 = nullptr;
   DMatrix*  JacCol2 = nullptr;
   DMatrix*  JacCol3 = nullptr;
   DMatrix*  xp = nullptr;
   DMatrix*  emax_history = nullptr;
   DMatrix*  order_reduction = nullptr;
   DMatrix*  old_relative_errors = nullptr;
   DMatrix*  error_scaling_weights = nullptr;
   ...
   int       nvars;
   int       ncons;
   int       **current_nodes = nullptr;
   int       jac_done;
   int*      iArow = nullptr;
   int*      jAcol = nullptr;
   int*      iGrow = nullptr;
   int*      jGcol = nullptr;
   double*   jac_values = nullptr;
   double*   jac_Aij = nullptr;
   double*   jac_Gij = nullptr;
   int       jac_nnz;
   int       jac_nnzA;
   int       jac_nnzG;
   double*   nrm_row = nullptr;
   unsigned int*      hess_ir = nullptr;
   unsigned int*      hess_jc = nullptr;
   unsigned int*      iGfun = nullptr;
   unsigned int*      jGvar = nullptr;
   unsigned int*      iGfun1 = nullptr;
   unsigned int*      jGvar1 = nullptr;
   unsigned int*      iGfun2 = nullptr;
   unsigned int*      jGvar2 = nullptr;
   int       use_constraint_scaling;
   int       F_nnz;
   double*   G2 = nullptr;
   adouble*  xad = nullptr;
   adouble*  gad = nullptr;
   adouble**  states = nullptr;
   adouble**  controls = nullptr;
   adouble**  parameters = nullptr;
   adouble**  resid = nullptr;
   adouble**  derivatives = nullptr;
   adouble**  initial_states = nullptr;
   adouble**  final_states = nullptr;
   adouble**  initial_controls = nullptr;
   adouble**  final_controls = nullptr;
   adouble**  events = nullptr;
   adouble**  path = nullptr;
   adouble**  states_traj = nullptr;
   adouble**  derivs_traj = nullptr;
   adouble**  second_derivs_traj = nullptr;
   adouble*   linkages = nullptr;
   adouble*   fgad = nullptr;
   adouble*   time_array_tmp = nullptr;
   adouble*   single_trajectory_tmp = nullptr;
   adouble*   L_ad_tmp = nullptr;
   adouble*   u_spline = nullptr;
   adouble*   z_spline = nullptr;
   adouble*   y2a_spline = nullptr;
   adouble**   states_next = nullptr;
   adouble**   controls_next = nullptr;
   adouble**   derivatives_next = nullptr;
   adouble**   path_next = nullptr;
   adouble**   path_bar = nullptr;
   adouble**   states_bar = nullptr;
   adouble**   controls_bar = nullptr;
   adouble**   derivatives_bar = nullptr;
   adouble**   observed_variable = nullptr;
   adouble**   observed_residual = nullptr;
   adouble**   lam_resid = nullptr;
   adouble**   interp_states_pe = nullptr;
   adouble**   interp_controls_pe = nullptr;
   double*    lambda_d = nullptr;
   double*    fg = nullptr;
   bool       trace_f_done;
   IGroup*    igroup = nullptr;
   char       text[2000];
   FILE*      psopt_solution_summary_file = nullptr;
   FILE*      mesh_statistics = nullptr;
   FILE*      mesh_statistics_tex = nullptr;
